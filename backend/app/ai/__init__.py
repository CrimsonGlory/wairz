...
from app.ai.tools.android_posture import register_android_posture_tools
...
def create_tool_registry() -> ToolRegistry:
    ...
    register_android_posture_tools(registry)
    ...
    # Q2 ds1qrsetup binary call-graph walker MCP tools (2026-05-27).
    # 3 tools: ds1qrsetup_callgraph_walk_status /
    # trigger_ds1qrsetup_callgraph_walk /
    # lookup_ds1qrsetup_callgraph_across_firmwares (Rule #44 MANDATORY
    ...
    register_ds1qrsetup_callgraph_tools(registry)
    ...
    # axis): trigger/get/export + the Rule #44 lookup_reachable_symbol_across_firmwares
    # (GIN-queried per-blob symbol presence; structural raise_only).
    register_reachability_export_tools(registry)
