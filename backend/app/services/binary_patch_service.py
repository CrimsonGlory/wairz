...
class BinaryPatchService:
    ...
    async def patch_function_return(
        ...
        try:
            os.chmod(patched_dir, 0o2775)  # noqa: S103 — container-shared dir must be group-writable for non-root build user  # nosec B103
        except OSError:
            pass
        ...
        try:
            os.chmod(out_host, 0o775)  # noqa: S103 — container-shared dir must be group-writable for non-root build user  # nosec B103
        except OSError:
            pass
